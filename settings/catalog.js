  ...
  const categories = Object.freeze([
    {
      ...
      items: Object.freeze([
        ...
        },
        {
          ...
          name: "搜索联想词",
          desc: "控制智能搜索分类和 Steam 商店搜索联想运行时",
          area: "store",
          enabled: true,
          member: true,
        ...
        },
        {
          id: "market-tools",
          name: "库存增强模块",
          desc: "控制库存增强设置分类和社区库存、市场、交易报价增强",
    ...
    },
    {
      ...
      items: Object.freeze([
        ...
        },
        {
          ...
          deps: depAll(["price-history", "reviews"]),
        },
        {
          id: "steam-events",
          name: "活动显示",
    ...
    },
    {
      id: "see",
      name: "库存增强",
      desc: "库存增强功能由 Steam Economy Enhancer 开源扩展提供，我在在集成这个代码时做了一些优化调整。",
      kind: "see",
      items: Object.freeze([]),
    },
  ]);
