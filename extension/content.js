...
(() => {
  ...
  function newsTranslatePublicConfig(featureOn, conf) {
    ...
    return {
      ...
      selection: conf?.selection !== false,
      selectionTrigger: String(conf?.selectionTrigger || "direct"),
      selectionAction: String(conf?.selectionAction || "click"),
      selectionClose: String(conf?.selectionClose || "auto"),
