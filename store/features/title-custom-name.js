...
((root, factory) => {
  ...
  function addStyle() {
    ...
    style.textContent = `
      ...
      #${MODAL_ID} .st-title-custom-name-panel {
      ...
      #${MODAL_ID} .st-title-custom-name-tabs {
        display: flex;
        gap: 4px;
        align-self: stretch;
        align-items: flex-end;
      }
      #${MODAL_ID} .st-title-custom-name-tabs button {
        min-width: 72px;
        min-height: 52px;
        border: 0;
      ...
      #${MODAL_ID} [data-title-custom-name-panel] {
        min-height: 0;
      }
      ...
      #${MODAL_ID} .st-title-custom-name-note-wrap {
        width: 100%;
        position: relative;
        display: block;
      }
      #${MODAL_ID} .st-title-custom-name-clear-note {
        position: static;
        min-height: 20px;
        height: 20px;
        border: 0;
      ...
      #${MODAL_ID} .st-title-custom-name-switch {
        position: relative;
        width: 40px;
        height: 22px;
        flex: 0 0 auto;
      ...
      #${MODAL_ID} .st-title-custom-name-switch input {
        position: absolute;
        inset: 0;
        width: 100%;
        height: 100%;
      ...
      #${MODAL_ID} .st-title-custom-name-switch input:disabled {
        cursor: not-allowed;
      }
      #${MODAL_ID} .st-title-custom-name-switch input:disabled + span {
        opacity: .48;
      }
      #${MODAL_ID} .st-title-custom-name-switch span {
        width: 40px;
        height: 22px;
        border-radius: 11px;
