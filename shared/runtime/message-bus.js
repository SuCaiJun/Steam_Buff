...
((root) => {
  ...
  const ROUTES = Object.freeze({
    ...
    SETTINGS_CLOUD_SYNC: { timeoutMs: 60 * 1000, owner: "settings" },
    USER_NAMES_COMMIT: { timeoutMs: 30 * 1000, owner: "library-independent-name" },
    AUTH_COMMIT: { timeoutMs: 8 * 1000, owner: "auth" },
    AI_GATEWAY_PERMISSION_CHECK: { timeoutMs: 5 * 1000, owner: "ai" },
    AI_GATEWAY_PERMISSION_REQUEST: { timeoutMs: 0, owner: "ai" },
    AI_GATEWAY_PERMISSION_OPEN: { timeoutMs: 10 * 1000, owner: "ai" },
    AI_GATEWAY_PERMISSION_CONTEXT: { timeoutMs: 5 * 1000, owner: "ai" },
    AI_GATEWAY_PERMISSION_CANCEL: { timeoutMs: 5 * 1000, owner: "ai" },
    CHROMIUM_WINDOW_OPEN: { timeoutMs: 10 * 1000, owner: "runtime" },
    STEAM_ROOT_MENU_OPEN_CHROMIUM: { timeoutMs: 10 * 1000, owner: "runtime" },
    AI_GATEWAY_PERMISSION_COMPLETE: { timeoutMs: 10 * 1000, owner: "ai" },
    AI_GATEWAY_PERMISSION_RESULT: { timeoutMs: 0, owner: "ai" },
