...
((root) => {
  ...
  const FEATURE_PAGES = Object.freeze({
    ...
    "subscription-info": Object.freeze(["store-details", "store-wishlist", "store-search", "store-other", "store-cart"]),
    "subscription-detail-card": Object.freeze(["store-app"]),
    "subscription-store-badge": Object.freeze(["store-details", "store-search", "store-other"]),
    "subscription-wishlist-badge": Object.freeze(["store-wishlist"]),
    "subscription-cart-badge": Object.freeze(["store-cart"]),
    "family-library-owned-marker": Object.freeze(["store-details", "store-wishlist", "store-search", "store-other", "store-cart"]),
    "family-library-detail-card": Object.freeze(["store-app"]),
    "family-library-store-badge": Object.freeze(["store-details", "store-search", "store-other"]),
